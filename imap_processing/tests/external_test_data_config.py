...
EXTERNAL_TEST_DATA = [
    ...
    (f"imap_codice_l0_lo-nsw-species_{VALIDATION_FILE_DATE}_v001.pkts", "codice/data/l1a_input/"),
    (f"imap_codice_l0_lo-sw-angular_{VALIDATION_FILE_DATE}_v001.pkts", "codice/data/l1a_input/"),
    (f"imap_codice_l0_lo-nsw-angular_{VALIDATION_FILE_DATE}_v001.pkts", "codice/data/l1a_input/"),
    ...
    (f"imap_codice_l0_lo-ialirt_{VALIDATION_FILE_DATE}_v001.pkts", "codice/data/l1a_input/"),
    (f"imap_codice_l0_lo-direct-events_{VALIDATION_FILE_DATE}_v001.pkts", "codice/data/l1a_input/"),
    (f"imap_codice_l0_hi-ialirt_{VALIDATION_FILE_DATE}_v001.pkts", "codice/data/l1a_input/"),
    ...
    (f"imap_codice_l0_raw_{VALIDATION_FILE_DATE}_v001.pkts", "codice/data/l1a_input/"),
